       ...
       <table className='overflow-x-auto w-full'>
        ...
        <tbody>
            {products.map((item)=>(
                ...
                <td className='px-4 py-2 flex items-center gap-3'><Link to={'/admin/edit'}><MdEdit className='text-blue-500' /></Link> <MdDelete className='text-red-500 cursor-pointer' onClick={()=>deleteProduct(item._id)} /></td>
            </tr>
            ))}
        </tbody>
       </table>
